The first major update to my project, an e-commerce shop for insectivorous plants. Link to version 1.0 here: . There have been a few noteworthy changes to the project:
